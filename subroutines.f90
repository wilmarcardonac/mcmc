  ...
  subroutine initialisation()
    ...
    If (likelihood .eq. 'gaussian') then
       ...
       If (use_gaussian_planck_prior) then
          ...
          parameters(2)%lower_limit = 1.d-3
          parameters(2)%upper_limit = 0.99d0
          parameters(2)%sigma = 1.1d-3
          parameters(2)%scale = 1.d0
          parameters(2)%latexname = '\omega_{cdm}'

          parameters(3)%name = 'n_s'
          parameters(3)%mean = 9.664d-1
          parameters(3)%lower_limit = 9.d-1
          parameters(3)%upper_limit = 1.1d0
          parameters(3)%sigma = 3.9d-3
          parameters(3)%scale = 1.d0
          parameters(3)%latexname = 'n_s'

          parameters(4)%name = 'ln10^{10}A_s'
          parameters(4)%mean = 3.039d0 !2.12424d-9
          parameters(4)%lower_limit = 2.7d0 !1.d-11
          parameters(4)%upper_limit = 4.0d0
          parameters(4)%sigma = 1.5d-2 !3.82d-11
          ...
          prior_parameters(4)%mean = 3.039d0 !2.12424d-9

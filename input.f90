Module input
  ...
  Integer*4,parameter    :: jumping_factor_update = 500    ! STEPS TAKEN BEFORE UPDATING JUMPING FACTOR (IF NEEDED)
...
!  Real*8 :: acceptance_ratio  ! IT STORES ACCEPTANCE RATIO FOR CURRENT CHAIN
  ...
  Character(len=*),parameter :: ROOT_PATH = '/datos/wilmar.cardona/projects/dea/g5nl/MI'

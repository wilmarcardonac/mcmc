Module input
  ...
  Integer*4,parameter :: number_iterations = 10000 !550000 ! TOTAL NUMBER OF ITERATIONS IN MCMC RUN
  ...
  Real*4,parameter :: lower_limit_ap = 0.1!0.2!0.1! LOWER LIMIT ACCEPTANCE PROBABILITY
  Real*4,parameter :: upper_limit_ap = 0.4!0.3!0.4! UPPER LIMIT ACCEPTANCE PROBABILITY

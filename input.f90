Module input
  ...
  Integer*4,parameter :: number_iterations = 1100!550000 ! TOTAL NUMBER OF ITERATIONS IN MCMC RUN
  ...
  Integer*4,parameter    :: covariance_matrix_update = 1000!2000 !5000!10000!0 ! STEPS TAKEN BEFORE UPDATING COVARIANCE MATRIX (IF NEEDED)
  Integer :: status1
  ...
  Character(len=*),parameter :: ROOT_PATH = '/home/wcardona/projects/deaMI/t10nl/mcmc'

Module input
  ...
  Integer*4,parameter :: number_iterations = 60000 ! TOTAL NUMBER OF ITERATIONS IN MCMC RUN
  Integer*4,parameter :: number_of_parameters = 12   ! TOTAL NUMBER VARYING PARAMETERS     
  ...
  Character(len=*),parameter :: ROOT_PATH = '/home/projects/deaMII/mcmc'

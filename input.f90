Module input
  ...
  Integer*4,parameter :: number_iterations = 2 !110000 ! TOTAL NUMBER OF ITERATIONS IN MCMC RUN
  ...
  Integer*4,parameter    :: steps_taken_before_definite_run = 10000 !10000 !5000!10000!0 ! STEPS TAKEN BEFORE FREEZING COVARIANCE MATRIX
  ...
  Character(len=*),parameter :: ROOT_PATH = '/datos/wilmar.cardona/projects/dea/t5l/modelI'

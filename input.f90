Module input
  ...
  Integer*4,parameter    :: covariance_matrix_update = 2000 !5000!0 ! STEPS TAKEN BEFORE UPDATING COVARIANCE MATRIX (IF NEEDED)
  Integer :: status1
  ...
  Character(len=*),parameter :: ROOT_PATH = '/home/snesseris/wilmar/projects/deaMI/t5nl/mcmc'

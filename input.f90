Module input
  ...
  Integer*4,parameter :: number_iterations = 67000 ! TOTAL NUMBER OF ITERATIONS IN MCMC RUN
  ...
  Integer*4,parameter    :: steps_taken_before_definite_run = 0 !20000 !5000!10000!0 ! STEPS TAKEN BEFORE FREEZING COVARIANCE MATRIX

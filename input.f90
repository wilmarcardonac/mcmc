Module input
  ...
  Integer*4,parameter    :: steps_taken_before_definite_run = 20000 !5000!10000!0 ! STEPS TAKEN BEFORE FREEZING COVARIANCE MATRIX
  ...
  Character(len=*),parameter :: ROOT_PATH = '/datos/wilmar.cardona/projects/dea/t5nl/MI'

Module input
  ...
  Integer*4,parameter :: number_iterations = 42000 ! TOTAL NUMBER OF ITERATIONS IN MCMC RUN
  ...
  Character(len=*),parameter :: ROOT_PATH = '/datos/wilmar.cardona/projects/dea/t10nl/MI'

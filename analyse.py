...
#filenames = fnmatch.filter(os.listdir("./chains/"),"mcmc_*.txt")
...
samples = loadMCSamples('/nfs/datos/wilmar.cardona/projects/dea/g10nl/MI/chains/mcmc_final_output',settings={'ignore_rows':.0})
...
#filebestfit = open("./chains/bestfit.txt",'w')

#filemeans = open("./chains/means.txt",'w')
...
stats.saveAsText('/nfs/datos/wilmar.cardona/projects/dea/g10nl/MI/chains/1Dstatistics.txt')
...
f.export('/nfs/datos/wilmar.cardona/projects/dea/g10nl/MI/chains/1D_plots.pdf')

print '1D PLOTS CREATED'

g.triangle_plot(samples,filled=True)#,params=['omega_b','omega_cdm','n_s','ln1010As','H0','m_ncdm','nc_bias_b0','logcs2fld','w0_fld','e_pi'],filled=True)
...
g.export('/nfs/datos/wilmar.cardona/projects/dea/g10nl/MI/chains/triangle_figure.pdf')
